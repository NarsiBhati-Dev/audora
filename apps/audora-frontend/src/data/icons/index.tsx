...
export const GridLayoutIcon: React.FC<IconProps> = ({ className = 'w-8 h-8' }) => (
...
export const SpeakerFullIcon: React.FC<IconProps> = ({ className = 'w-8 h-8' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" className={className}>
    <rect x="1.5" y="3.5" width="17" height="13" rx="1.5" stroke="currentColor" strokeWidth="1.5"></rect>
  </svg>
);


export const SpeakerSplitIcon: React.FC<IconProps> = ({ className = 'w-8 h-8' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" className={className}>
    <rect x="1.5" y="3.5" width="17" height="13" rx="1.5" stroke="currentColor" strokeWidth="1.5"></rect>
...
export const ScreenShareIcon: React.FC<IconProps> = ({ className = 'w-8 h-8' }) => (
  <svg width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M10.5 1.5H11.5C13.1569 1.5 14.5 2.84315 14.5 4.5V13.5C14.5 15.1569 13.1569 16.5 11.5 16.5H10.5C8.84315 16.5 7.5 15.1569 7.5 13.5V4.5C7.5 2.84315 8.84315 1.5 10.5 1.5Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
    <path d="M1.5 10H10.5C12.1569 10 13.5 11.3431 13.5 13V16.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
  </svg>
);

export const ScreenFillIcon: React.FC<IconProps> = ({ className = 'w-8 h-8' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" className={className} >
    <path fillRule="evenodd" clipRule="evenodd" d="M1.25 3C1.25 2.0335 2.0335 1.25 3 1.25H17C17.9665 1.25 18.75 2.0335 18.75 3V17C18.75 17.9665 17.9665 18.75 17 18.75H3C2.0335 18.75 1.25 17.9665 1.25 17V3ZM3 2.75C2.86193 2.75 2.75 2.86193 2.75 3V17C2.75 17.1381 2.86193 17.25 3 17.25H17C17.1381 17.25 17.25 17.1381 17.25 17V3C17.25 2.86193 17.1381 2.75 17 2.75H3ZM12.25 5C12.25 4.58579 12.5858 4.25 13 4.25H14C14.9665 4.25 15.75 5.0335 15.75 6V7C15.75 7.41421 15.4142 7.75 15 7.75C14.5858 7.75 14.25 7.41421 14.25 7V6C14.25 5.86193 14.1381 5.75 14 5.75H13C12.5858 5.75 12.25 5.41421 12.25 5ZM7 15.75C7.41421 15.75 7.75 15.4142 7.75 15C7.75 14.5858 7.41421 14.25 7 14.25H6C5.86193 14.25 5.75 14.1381 5.75 14V13C5.75 12.5858 5.41421 12.25 5 12.25C4.58579 12.25 4.25 12.5858 4.25 13L4.25 14C4.25 14.9665 5.0335 15.75 6 15.75H7ZM15 12.25C15.4142 12.25 15.75 12.5858 15.75 13V14C15.75 14.9665 14.9665 15.75 14 15.75H13C12.5858 15.75 12.25 15.4142 12.25 15C12.25 14.5858 12.5858 14.25 13 14.25H14C14.1381 14.25 14.25 14.1381 14.25 14V13C14.25 12.5858 14.5858 12.25 15 12.25ZM4.25 7C4.25 7.41421 4.58579 7.75 5 7.75C5.41421 7.75 5.75 7.41421 5.75 7V6C5.75 5.86193 5.86193 5.75 6 5.75L7 5.75C7.41421 5.75 7.75 5.41421 7.75 5C7.75 4.58579 7.41421 4.25 7 4.25H6C5.0335 4.25 4.25 5.0335 4.25 6L4.25 7Z" fill="#fff"></path>
  </svg>
);

export const ScreenFitIcon: React.FC<IconProps> = ({ className = 'w-8 h-8' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" className={className} >
    <path fillRule="evenodd" clipRule="evenodd" d="M1.25 5C1.25 4.0335 2.0335 3.25 3 3.25H17C17.9665 3.25 18.75 4.0335 18.75 5V15C18.75 15.9665 17.9665 16.75 17 16.75H3C2.0335 16.75 1.25 15.9665 1.25 15V5ZM3 4.75C2.86193 4.75 2.75 4.86193 2.75 5V15C2.75 15.1381 2.86193 15.25 3 15.25H17C17.1381 15.25 17.25 15.1381 17.25 15V5C17.25 4.86193 17.1381 4.75 17 4.75H3ZM15 10.25C15.4142 10.25 15.75 10.5858 15.75 11V12C15.75 12.9665 14.9665 13.75 14 13.75H13C12.5858 13.75 12.25 13.4142 12.25 13C12.25 12.5858 12.5858 12.25 13 12.25H14C14.1381 12.25 14.25 12.1381 14.25 12V11C14.25 10.5858 14.5858 10.25 15 10.25ZM4.25 9C4.25 9.41421 4.58579 9.75 5 9.75C5.41421 9.75 5.75 9.41421 5.75 9V8C5.75 7.86193 5.86193 7.75 6 7.75L7 7.75C7.41421 7.75 7.75 7.41421 7.75 7C7.75 6.58579 7.41421 6.25 7 6.25H6C5.0335 6.25 4.25 7.0335 4.25 8L4.25 9Z" fill="#fff"></path>
  </svg>
);