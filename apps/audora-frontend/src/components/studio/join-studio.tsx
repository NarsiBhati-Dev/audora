    ...
    <div className='mx-auto w-full max-w-lg px-4 sm:px-6'>
      <div className='flex flex-col gap-4'>
        <p className='text-sm text-zinc-400'>
          ...
          <span className='font-medium text-white'>narsidd</span>
        </p>
        ...
        <button className='bg-primary-400 hover:bg-primary-500 w-full rounded-lg px-4 py-2.5 text-sm font-medium text-white transition'>
          Join Studio
        </button>
